...
export default class Cadastro extends React.Component {
    ...
    adicionarCurso(e) {
        ...
        if(_id && _id.trim() !== ' '){
            ...
            .then(_ => {
                this.callbackSucess('Curso atualizado')
        }).catch(this.callbackError);
        }else{
            axios.post(URL, body)
            .then(_ => {
                this.callbackSucess('Curso adicionado')
        }).catch(this.callbackError);
        }
    }

    callbackSucess  = function(msg){
        alert(msg)
    ...
    removerCurso = function (curso) {
        if (window.confirm("Você realmente deseja deletar o curso selecionado?")) {
    ...
    consultarCurso = function(curso){
        this.setState({...this.state,_id: curso._id,
                                     codigo: curso.codigo,
                                     preco: curso.preco,
